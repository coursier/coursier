...
libraryDependencies ++= Seq(
  "com.github.alexarchambault" %% "coursier-java-6" % "1.0.0" % "1.0.0-M10",
  "com.github.alexarchambault" %% "coursier-cache-java-6" % "1.0.0" % "1.0.0-M10"
)
```
...
```scala
addSbtPlugin("com.github.alexarchambault" % "coursier-sbt-plugin-java-6" % "1.0.0" % "1.0.0-M10")
```
...
```
$ ./coursier bootstrap \
    com.github.alexarchambault:coursier-cli-java-6" % "1.0.0_2.11:1.0.0-M10 \
    -b -f -o coursier \
...
The first module, `"com.github.alexarchambault" %% "coursier-java-6" % "1.0.0-M10"`, mainly depends on
...
The second module, `"com.github.alexarchambault" %% "coursier-cache-java-6" % "1.0.0-M10"`, is precisely in charge of fetching
