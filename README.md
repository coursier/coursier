...
libraryDependencies ++= Seq(
  "io.get-coursier" %% "coursier-java-6" % "1.0.0-M11",
  "io.get-coursier" %% "coursier-cache-java-6" % "1.0.0-M11"
)
```
...
```
$ ./coursier bootstrap \
    io.get-coursier:coursier-cli-java-6_2.11:1.0.0-M11 \
    -b -f -o coursier \
...
The first module, `"io.get-coursier" %% "coursier-java-6" % "1.0.0-M11"`, mainly depends on
...
The second module, `"io.get-coursier" %% "coursier-cache-java-6" % "1.0.0-M11"`, is precisely in charge of fetching
