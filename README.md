...
libraryDependencies ++= Seq(
  "com.github.alexarchambault" %% "coursier-java-6" % "1.0.0" % "1.0.0-M8",
  "com.github.alexarchambault" %% "coursier-cache-java-6" % "1.0.0" % "1.0.0-M8"
)
```
...
```scala
addSbtPlugin("com.github.alexarchambault" % "coursier-sbt-plugin-java-6" % "1.0.0" % "1.0.0-M8")
```
...
```
$ ./coursier bootstrap \
    com.github.alexarchambault:coursier-cli-java-6" % "1.0.0_2.11:1.0.0-M8 \
    -b -f -o coursier \
...
The first module, `"com.github.alexarchambault" %% "coursier-java-6" % "1.0.0" % "1.0.0-M8"`, mainly depends on
...
The second module, `"com.github.alexarchambault" %% "coursier-cache-java-6" % "1.0.0" % "1.0.0-M8"`, is precisely in charge of fetching
