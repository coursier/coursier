...
This is all that is needed for Coursier to serve as a replacement for the built-in dependency fetching of sbt. Use sbt as you otherwise would. Coursier has its cache in `~/.coursier` (by default).
