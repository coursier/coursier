...
object Deps {
  ...
  def jlineTerminalJansi = "org.jline" % "jline-terminal-jansi" % "3.13.3"
  ...
  object cross {
    ...
    def scalaJsReact = setting("com.github.japgolly.scalajs-react" %%% "core" % "1.6.0")
    def scalazCore = setting("org.scalaz" %%% "scalaz-core" % versions.scalaz)
    def utest = setting("com.lihaoyi" %%% "utest" % "0.7.3")
  }
