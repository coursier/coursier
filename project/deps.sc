...
object Deps {
  ...
  def catsEffect        = ivy"org.typelevel::cats-effect::3.5.2"
  ...
  def jsoup          = ivy"org.jsoup:jsoup:1.16.2"
  ...
  def proguard                 = ivy"com.guardsquare:proguard-base:7.4.0"
  def pythonNativeLibs         = ivy"ai.kien::python-native-libs:0.2.4"
  def scalaAsync               = ivy"org.scala-lang.modules::scala-async:0.10.0"
  def scalaCliConfig           = ivy"org.virtuslab.scala-cli::config:1.0.6"
  ...
  def scalaNativeTools040      = ivy"org.scala-native::tools:0.4.16"
