...
- Active cross Scala versions: `2.13.18`, `3.9.0`. `2.12.21` only for the modules sbt-coursier depends on (util, core, cache, coursier, sbt-maven-repository) and the modules testing them, see `ScalaVersions` in `mill-build`.
