...
public class Shoestrap {
     ...
     * @throws IOException
     */
    static Map<String, URL[]> readIsolationContexts(File cacheDir, String[] isolationIDs, ClassLoader loader) throws IOException {
        ...
        for (String isolationID: isolationIDs) {
            ...
            List<URL> urls = getURLs(strUrls, loader);
            List<URL> localURLs = getLocalURLs(urls, cacheDir);
    ...
    static String mainJarPath() {
        ProtectionDomain protectionDomain = Shoestrap.class.getProtectionDomain();
     ...
     */
    static List<URL> getLocalURLs(List<URL> urls, final File cacheDir) throws MalformedURLException {
    ...
    static List<URL> getURLs(String[] rawURLs, ClassLoader loader) throws MalformedURLException {
    ...
    public static void main(String[] args) throws Throwable {
        ...
        List<URL> urls = getURLs(strUrls, contextLoader);
        List<URL> localURLs = getLocalURLs(urls, cacheDir);

        String[] isolationIDs = readStringSequence(isolationIDsResource);
        Map<String, URL[]> perIsolationContextURLs = readIsolationContexts(cacheDir, isolationIDs, contextLoader);
