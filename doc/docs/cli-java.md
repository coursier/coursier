...
default JVM is version 25 from the [JVM index](#jvm-index) — [Temurin](https://adoptium.net)
...
(version 25 in the JVM index — Temurin on most platforms, Zulu on macOS ARM, Liberica on Windows ARM).
