  ...
  object Deps {
    ...
    def scalaCliConfig(sv: String) =
      if (sv.startsWith("2.12"))
        ...
        mvn"org.virtuslab.scala-cli:config_3:1.8.3"
    ...
    def scodec                   = mvn"org.scodec::scodec-core:2.3.2"
    def shapeless                = mvn"com.chuusai::shapeless:2.3.12"
    def slf4JNop                 = mvn"org.slf4j:slf4j-nop:2.0.17"
    def svm                      = mvn"org.graalvm.nativeimage:svm:21.3.13"
    def tika                     = mvn"org.apache.tika:tika-core:3.2.1"
    def ujson                    = mvn"com.lihaoyi::ujson:4.2.1"
    ...
    def zstdJni = mvn"com.github.luben:zstd-jni:1.5.7-3"
  }
