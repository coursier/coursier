package coursier.tests.complete

import coursier.Repositories
import coursier.complete._
...
object CompleteTests extends TestSuite {
  ...
  import coursier.tests.TestHelpers.{ec, cache, handmadeMetadataCache}
  ...
  val tests = Tests {
    ...
    test("maven") {
      ...
      test {
        val expected = 17 -> Seq(
          ...
          "coursier-sbt-maven-repository",
          "coursier-sbt-maven-repository_sjs1",
          ...
          "dependency-js_sjs1",
          "dependency-jvm",
          "dependency-native_native0.4",
          "dependency",
          "dependency_native0.4",
          "dependency_native0.5",
          "dependency_sjs1",
          "echo",
          "fetch-js_sjs1",
          "http-server",
      ...
      test {
        val expected = 32 -> Seq(
          ...
          "2.1.0-M2",
          "2.1.0-M2-1",
          "2.1.0-M2-19-g5a34ba7c1",
          "2.1.0-M3",
          "2.1.0-M3-1",
          "2.1.0-M4",
          "2.1.0-M4-1",
          "2.1.0-M5",
          "2.1.0-M5-1-gc8a0a64bd",
          "2.1.0-M5-5-g2cb552ea9",
          "2.1.0-M5-18-gfebf9838c",
          "2.1.0-M5-24-g678b31710",
          "2.1.0-M6",
          "2.1.0-M6-26-gcec901e9a",
          "2.1.0-M6-28-gbad85693f",
          "2.1.0-M6-44-gc47ecec07",
          "2.1.0-M6-49-gff26f8e39",
          "2.1.0-M6-53-gb4f448130",
          "2.1.0-M7",
          "2.1.0-M7-18-g67daad6a9",
          "2.1.0-M7-34-gf519b50a3",
    ...
    test(
      ...
      test - simple(
        ...
        28 -> List("0.2.0", "0.2.1", "0.2.2", "0.2.3", "0.2.4", "0.2.5", "0.3.0", "0.3.1", "0.3.2")
      )
      test - simple("io.get-coursierz", 0 -> Nil)
    }
  }
