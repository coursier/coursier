...
class CliFetchIntegrationTest extends FlatSpec with CliTestLib with Matchers {
  ...
  it should "fail to resolve, but try to fetch artifacts anyway" in {
    ...
    val expectedUrls = Seq(
      ...
      "com/github/alexarchambault/case-app-annotations_2.12/2.0.0-M6/case-app-annotations_2.12-2.0.0-M5.jar",
      "com/github/alexarchambault/case-app-util_2.12/2.0.0-M6/case-app-util_2.12-2.0.0-M5.jar",
      "com/github/alexarchambault/case-app_2.12/2.0.0-M6/case-app_2.12-2.0.0-M5.jar",
