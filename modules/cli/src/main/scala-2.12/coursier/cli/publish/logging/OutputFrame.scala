...
final class OutputFrame(
  ...
  private val pool = Executors.newScheduledThreadPool(1, Schedulable.daemonThreadFactory())
  ...
  def stop(keepFrame: Boolean = true): Unit = {
...
object OutputFrame {
  ...
  private final class Lines(bufferSize: Int) {
    ...
    @volatile private[this] var first: Line = null
    @volatile private[this] var last: Line = null
  ...
  private final class Line(val value: String, val index: Long) {
    ...
    @volatile private[this] var next0: Line = null
