...
/**
  ...
  *
  * @param path Path traversed so far to the current item. The head of path is the current focus of the zipper
  * @param fetchChildren Function used to fetch the children of the current focus
  */
final class TreeZipper[A: Eq](
  ...
  /**
    * This operation will return a chain of zippers pointing to each of the siblings
  ...
  /**
    * This operation returns a chain of zippers pointing to each of the children of the current focus.
    * 
    * In the present of any cycles (any children poiting to an item already present in the path), then
    * it will be skipped in the returned chain.
    */
...
object TreeZipper {
  /**
    ...
    *
    * @param root Root to be used for the zipper
    * @param fetchChildren Operation that will return the children of any given item
    * @return A new zipper focused at the given root
    */
