  ...
  val tests = TestSuite {
    ...
    'parse {
      ...
      'multiRange - {
        * - {
          ...
          assert(
            itv == Some(
              VersionInterval(Some(Version("1.0")), Some(Version("2.0")), fromIncluded = true, toIncluded = false)
            )
          )
        }
        ...
        * - {
          ...
          assert(
            itv == Some(
              VersionInterval(Some(Version("3.0")), Some(Version("4.0")), fromIncluded = true, toIncluded = false)
            )
          )
        }
        ...
        * - {
          ...
          assert(
            itv == Some(
              VersionInterval(Some(Version("5.0")), Some(Version("6.0")), fromIncluded = true, toIncluded = false)
            )
          )
        }
        ...
        * - {
          ...
          assert(
            itv == Some(
              VersionInterval(Some(Version("5.0")), Some(Version("6.0")), fromIncluded = false, toIncluded = false)
            )
          )
        }
      }
    ...
    'constraint {
      ...
      'interval {
        ...
        assert(
          c1 == Some(
            VersionConstraint.interval(VersionInterval(Parse.version("1.3"), Parse.version("2.4"), true, false))
          )
        )
      }
    }
